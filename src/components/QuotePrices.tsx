...
export const QuotePrices = ({ quotePrices, setQuotePrices }: QuotePricesProps) => {
  ...
  const addTier = (index: number) => {
    ...
    newPrices[index].prices.push({ quantity: 0, unitPrice: 0, currency: 'USD' });
            ...
            <Row key={tierIndex} gutter={12} align="middle" className="mb-2" wrap={false}>
              <Col flex="100px">
                <Input
                  ...
                  onChange={e => {
                    const newPrices = [...quotePrices];
                    newPrices[index].prices[tierIndex].quantity = Number(e.target.value);
                    setQuotePrices(newPrices);
                  }}
                />
              </Col>
              <Col flex="140px">
                <Input
                  ...
                  onChange={e => {
                    const newPrices = [...quotePrices];
                    newPrices[index].prices[tierIndex].unitPrice = Number(e.target.value);
                    setQuotePrices(newPrices);
                  }}
                />
              </Col>
